...
import top.yichenghu.javadb.backend.im.BPlusTree;
...
import top.yichenghu.javadb.backend.utils.ParseStringRes;
import top.yichenghu.javadb.backend.utils.Parser;
import top.yichenghu.javadb.common.Error;

/**
 * field is the information of fields of table
 * Binary format is:
 * [FieldName][TypeName][IndexUid]
 * If the field has no index, the IndexUid is 0.
 */
public class Field {
    long uid;
    private Table tb;
